  ...
  return (
    <div className="min-h-screen w-full flex justify-center bg-[#4969B2]">
      <div className="relative
        ...
        <div ref={headerRef} className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[390px] z-50">
          <div className="relative bg-[#4969B2]">
            <header className="h-20 flex items-center justify-between px-5">
              {/* back arrow */}
              <Link to={`/prof/dashboard/${session_id}`} className="top-6 left-6 text-white">
                  <ArrowLeft size={32} />
              </Link>
        ...
        {/* classNum & date */}
        <div className="flex px-8 mb-1 items-center pt-[100px]">
          <div>
            <div className="text-white text-3xl font-bold mb-1">{classNum}</div>
            <div className="bg-white text-xs font-semibold px-4 py-1 rounded-lg w-fit mb-4">
