...
router.patch("/class-attendance/:class_id/:user_id", editStudentStatus); // PUT: edit user status
router.get("/check-in/status/:class_id/:user_id", getAttendanceStatus); // GET: check f already check in that class
